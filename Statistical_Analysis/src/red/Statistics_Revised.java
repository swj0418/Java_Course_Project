...
public class Statistics_Revised {
	private Stock stock;
	...
	public Statistics_Revised() {
		System.out.println("Specify your stock by its Symbol");
	}
	
	public Statistics_Revised(String SYMBOL) {
	...
	public Statistics_Revised(String SYMBOL, int TimeSlice) {
		String defaultstartdate = "2016-01-01";
		String defaultenddate = Utils.GetLastDayOfTheTrade(SYMBOL);
		String defaultdatatype = "ADJ_CLOSE";
		this.SYMBOL = SYMBOL;
	...
	public Statistics_Revised(String SYMBOL, int TimeSlice, String DataType) {
		String defaultstartdate = "2016-01-01";
		String defaultenddate = Utils.GetLastDayOfTheTrade(SYMBOL);
		this.SYMBOL = SYMBOL;
		this.TimeSlice = TimeSlice;
	...
	public Statistics_Revised(String SYMBOL, String Startdate, String Enddate, int TimeSlice, String DataType) {
		this.SYMBOL = SYMBOL;
		this.TimeSlice = TimeSlice;
		this.DataType = DataType;
